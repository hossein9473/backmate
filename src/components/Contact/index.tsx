  ...
  return (
    <section id="contact" className="overflow-hidden pb-16 md:pb-20 lg:pb-28">
      <div className="container">
        <div className="-mx-4 flex flex-wrap justify-center my-10">
          <div dir="rtl" className="w-full px-4 lg:w-7/12 xl:w-8/12">
            <div
              className="mb-12 rounded-3xl bg-white px-8 py-11 shadow-three dark:bg-gray-dark sm:p-[55px] lg:mb-5 lg:px-8 xl:p-[55px]"
              data-wow-delay=".15s"
            >
